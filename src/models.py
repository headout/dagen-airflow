...
class DagenDagVersion(Base):
    ...
    creator = relationship(User, foreign_keys='DagenDagVersion.creator_id', lazy='select')
    approver = relationship(User, foreign_keys='DagenDagVersion.approver_id', lazy='select')
